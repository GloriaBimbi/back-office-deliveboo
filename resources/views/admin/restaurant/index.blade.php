...
<section>
    <div class="container my-5">
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a class="btn btn-primary" href="{{route('admin.restaurants.show', $restaurant)}}"><i class="fa-solid fa-eye"></i></a>

                        {{-- # bottone che dovrebbe attivare la modale  --}}
                        <button type="submit" class="btn btn-danger" data-bs-toggle="delete-restaurant-{{ $restaurant->id }}" data-bs-target="#delete-restaurant-{{ $restaurant->id }}">
        ...
        <div class="row">
            <div class="col"><a href="{{route('admin.restaurants.create')}}" class="btn btn-primary"><i class="fa-solid fa-plus"></i> Add Restaurant </a></div>
